...
//        Log.d("main_idea", l + "  " + t + "  " + oldl + "  " + oldt);
//        if (ImageView != null && t != oldt) {
//            ImageView.setTranslationY(t / 2);
//        }

        if (banner != null && t <= point.x - headerHeight && getOnScrollChangedColorListener() != null) {
    ...
    public void setbanner(Banner banner, int headerHeight) {
        this.banner = banner;
