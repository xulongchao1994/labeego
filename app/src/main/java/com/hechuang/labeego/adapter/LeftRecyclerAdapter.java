...
public class LeftRecyclerAdapter extends RecyclerView.Adapter<LeftRecyclerAdapter.ViewHolder> {
    ...
    private List<ShopClassify_liftBean> bigSortList;
    private RecyclerView recyclerView;
    private LeftListener listener;
    private int selectedPosition;

    public LeftRecyclerAdapter(Context context, List<ShopClassify_liftBean> bigSortList, RecyclerView recyclerView) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //填充Item中的布局
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_shopclassify_lift, parent, false);
        // 实例化viewholder
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        // 绑定数据
        holder.tvName.setText(bigSortList.get(position).getTitle());
        //item点击后背景的变化
        if (position == selectedPosition) {
            holder.tvName.setTextColor(context.getResources().getColor(R.color.order_N_textclor));
            ...
            holder.tvName.setBackgroundColor(ContextCompat.getColor(context, R.color.liftrecyclerview));
        }
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView, final LeftListener listener) {
            super(itemView);
            tvName = (TextView) itemView.findViewById(R.id.shopclaify_lift_item_text);
            view = itemView.findViewById(R.id.shopclassify_lift_item_view);
